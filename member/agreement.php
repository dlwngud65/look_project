...
if($flag !=="OK"){
    $sql= "create table member(
                ...
                memberkind  char(1) ,
                rank        char(9) default 'beginner',
                point       int default 3000 ,
                total_point int default 0,
                total_pay   int default 0,
                primary key(id)
               )";
    if(mysqli_query($con,$sql)){//결과값이 없음으로 true false
...
//적립금.
while($row=mysqli_fetch_row($result)){
    if($row[0]===point_use_date){
        $flag2 ="OK";
        break;
    }
}
if($flag2 !=="OK"){
    $sql= "create table point_use_date(
                id          char(20) not null,
    ...
    if(mysqli_query($con,$sql)){//결과값이 없음으로 true false
        echo "<script>alert('{point_use_date} 테이블이 생성되었습니다.')</script>";
    }else{
        echo "실패원인:".mysqli_query($con);
    }
}
	...
	<div class="basic_shape">
		...
		<nav id="Joinus_nav">
			...
			<fieldset>
				...
				<textarea rows="20" cols="170" readonly="readonly">
제1조(목적)
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
				...
				<div class="checkbox">
					<b>이용약관에 동의하십니까?</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
						id="agree1" type="checkbox" value="y"><b>동의함</b>
				</div>
			</fieldset>
			<div></div>
			<fieldset>
				<legend>
					<b>개인 정보 수집 및 이용 동의</b>
				</legend>
				<textarea rows="20" cols="170" readonly="readonly">
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
				...
				<div class="checkbox">
					<b>이용약관에 동의하십니까?</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
						id="agree2" type="checkbox" value="y"><b>동의함</b>
				</div>
			</fieldset>
			<div id="Joinus_button_box">
				<input type="button" onclick="checkagree()" value="회원가입">
				<a href="../index.php"><input type="button" value="가입취소"></a>
			</div>
		</nav>
