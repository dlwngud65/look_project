       ...
       $("#search_text2").keyup(function(){
          ...
          if(search_text.length <= 0){
             ...
             $.ajax({
                ...
                data : "search_text="+search_text+"&page=2",
...
<header>
   <div id="Menu_box">
      ...
      <a href="../product_list/product_list_main.php?mode=pants"
         class="Menu" class="Menu">Pants</a> <a
      ...
      <form name="search_text2" action="../search/search.php" method="post"
         ...
         <div id="search">
            <input type="text" id="search_text2" name="search_text2" autofocus
               ...
               src="../img/search_button.png" onclick="submit2()">
         </div>
      </form>
   </div>
</header>
